...
El sistema debe permitir observar el comportamiento del flujo vehicular en tiempo real, donde los vehículos avanzan mediante hilos de ejecución, respetan los estados del semáforo y evitan colisiones entre sí. El objetivo es simular de manera visual y dinámica la regulación del tráfico en una intersección urbana.
